...
public class RunSimulation2 {
   ...
   */
  public RunSimulation2(String mapFile, int iterations) {
  ...
  public static void main(String[] args) {
    ...
    String mapFile = "maps/public/map02.txt";
    int iterations = 200;
    RunSimulation2 sim = new RunSimulation2(mapFile, iterations);
    sim.run();
  }
}